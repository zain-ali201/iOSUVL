...
- (void)setUp
{
    ...
    [self.textLabel setTextColor:[UIColor colorWithRed:221/255.0 green:78.0/255.0 blue:66.0/255.0 alpha:1.0]];
...
- (void)changeColorForState:(UIControlState)state
{
    ...
    self.textLabel.textColor = [UIColor colorWithRed:221/255.0 green:78.0/255.0 blue:66.0/255.0 alpha:1.0];
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    roundedRectanglePath.lineWidth = 1.5 * self.checkboxSideLength / CTCheckboxDefaultSideLength;
